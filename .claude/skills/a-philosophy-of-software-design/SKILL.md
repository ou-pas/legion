...
description: OBEY rules distilled from John Ousterhout's A Philosophy of Software Design — use when designing module interfaces, fighting complexity, deciding what to hide, or reviewing depth of abstractions.
---
