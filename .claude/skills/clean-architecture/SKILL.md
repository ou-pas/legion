...
description: OBEY rules distilled from Robert Martin's Clean Architecture — use when deciding dependencies between layers/modules, isolating frameworks and IO, or splitting a monolith file. Read BEFORE any structural change.
---
