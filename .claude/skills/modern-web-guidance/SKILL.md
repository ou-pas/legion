...
---
*Source : [GoogleChrome/modern-web-guidance](https://github.com/GoogleChrome/modern-web-guidance) (Apache-2.0) — importé le 24/08/2026.*
*Sans réseau (container de session) : le CLI npx est indisponible — chercher directement dans `guides/<catégorie>/*.md` avec grep.*
