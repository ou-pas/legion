...
description: OBEY rules distilled from Eric Evans' Domain-Driven Design — use when structuring modules, naming from the ubiquitous language, placing business logic, or drawing bounded contexts. Read BEFORE any structural change.
---
...
---
*Source : [ciembor/agent-rules-books](https://github.com/ciembor/agent-rules-books) (MIT), version mini — importé le 24/08/2026.*
