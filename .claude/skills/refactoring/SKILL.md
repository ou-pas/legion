---
name: refactoring
description: OBEY rules distilled from Martin Fowler's Refactoring — use when restructuring existing code safely: smells, small steps, tests first, never mixing refactor and behavior change.
---
